...
def evaluate_performance(dataset_path, results_dir, latex=False):
    sequences = []
...
parser.add_argument("--latex", help="Latex", required=False, action='store_true')

args = parser.parse_args()

evaluate_performance(args.dataset, args.results_dir, args.latex)
